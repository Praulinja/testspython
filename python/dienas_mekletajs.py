...
#?sis nestrāda
def menesu_parbaude (menesis_dz, menesis_sis):
    pareizs_menesis = True
    if menesis_dz>12 or menesis_sis>12:
        pareizs_menesis = False
    
    if pareizs_menesis == False:
        print("Ievadītais mēnesis ir no citas skaitīšanas sistēmas!")
